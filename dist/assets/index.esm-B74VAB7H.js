import{al as y,am as b,an as T,ao as S,ap as K,aq as be,ar as W,as as Y,at as J,au as X,av as Q,aw as D,ax as Te,ay as Ae,az as ve,aA as q}from"./index-DMXCqHay.js";import"./three-BXUBjeT-.js";import"./konva-CAv-Ixzy.js";const Z="@firebase/installations",F="0.6.24";/**
 * @license
 ...
 */const ee=1e4,te=`w:${F}`,ne="FIS_v2",Se="https://firebaseinstallations.googleapis.com/v1",ke=60*60*1e3,Ee="installations",Re="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},m=new K(Ee,Re,Ce);function ae(e){return e instanceof W&&e.code.includes("request-failed")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me="installations",rt="installations-internal",st=e=>{const t=e.getProvider("app").getImmediate(),n=it(t),a=S(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},ot=e=>{const t=e.getProvider("app").getImmediate(),n=S(t,me).getImmediate();return{getId:()=>tt(n),getToken:i=>nt(n,i)}};function ct(){b(new T(me,st,"PUBLIC")),b(new T(rt,ot,"PRIVATE"))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kt(e=Te()){e=D(e);const t=S(e,v);return t.isInitialized()?t.getImmediate():jt(e)}function jt(e,t={}){const n=S(e,v);if(n.isInitialized()){const i=n.getImmediate();if(Ae(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function Wt(){if(Y()||!J()||!X())return!1;try{return await Q()}catch{return!1}}function Bt(e,t,n){e=D(e),Ot(x,I[e.app.options.appId],t,n).catch(a=>u.error(a))}function Ut(e,t,n,a){e=D(e),Ft(x,I[e.app.options.appId],t,n,a).catch(i=>u.error(i))}const G="@firebase/analytics",H="0.10.25";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(){b(new T(v,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return Lt(a,i,n)},"PUBLIC")),b(new T("analytics-internal",e,"PRIVATE")),y(G,H),y(G,H,"esm2020");function e(t){try{const n=t.getProvider(v).getImmediate();return{logEvent:(a,i,r)=>Ut(n,a,i,r),setUserProperties:(a,i)=>Bt(n,a,i)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Vt();export{Kt as getAnalytics,jt as initializeAnalytics,Wt as isSupported,Ut as logEvent,Bt as setUserProperties};
